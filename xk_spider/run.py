...
publicCourses = [
    ['乡村发展与治理', '蔡葵','202120221YN303218005902'],
    ['幸福在哪里', '姜素萍','202120221YN302118000301']
...
for course in publicCourses:
    print(course[1])
    taskList.append(ec.submit(gc.judge, course[0], course[1], course[2], key, kind='素选'))
for course in programCourse:
    taskList.append(ec.submit(gc.judgepr, course[0], course[1], key, kind='主修'))
